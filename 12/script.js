...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const colorList=['red','green','pink','purple','blue','orange'];
    ...
    while(true){
        let item=prompt("Что нужно купить на нг друзьям?","");
    ...
    const notifList=['Здравствуйте','Мы из компании орифлейм','Я хочу пиццу!','Не хочу сессию('];
